  ...
  <div class="products-page">
    <div class="container">
      ...
      <div class="page-header">
        ...
        <p class="page-subtitle">Find the perfect drone parts for your project</p>
      </div>
          ...
          <main class="products-main">
            ...
            <div class="top-controls">
              ...
              <div class="results-info">
                ...
                <span v-if="selectedCategory" class="results-category">in {{ selectedCategory }}</span>
                <span v-if="debouncedSearchQuery" class="results-search">matching "{{ debouncedSearchQuery }}"</span>
            ...
            <!-- Products Grid -->
            <div v-if="products.length > 0" class="products-grid" :class="viewMode">
              <ProductCard
