          ...
          <div class="tab-content">
            ...
            <div v-if="activeTab === 'specifications'" class="tab-panel">
              <div class="specifications-content">
                <div v-if="product.specifications && Object.keys(product.specifications).length > 0" class="specs-grid">
...
const fetchProduct = async () => {
  ...
  try {
    ...
    if (product.value && product.value.category) {
      ...
      const response = await getProducts({ category: product.value.category })
