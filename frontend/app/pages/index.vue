        ...
        <div class="hero-content">
          <div class="hero-text">
            ...
            <p class="hero-subtitle">
              Discover high-quality motors, propellers, flight controllers, and more. 
    ...
    <section class="categories-section">
      <div class="container">
        <div class="section-header">
          ...
          <p class="section-subtitle">Find exactly what you need for your drone project</p>
        </div>
        ...
        <div class="categories-grid">
          ...
          >
            ...
            <p class="category-description">High-quality {{ category.toLowerCase() }} for your drone</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="promo-content">
          <div class="promo-text">
            ...
            <p class="promo-subtitle">Get your drone parts delivered fast and free</p>
        ...
        <div class="testimonials-grid">
          <div class="testimonial-card">
            ...
            <p class="testimonial-text">
              "Excellent quality motors and fast shipping. My drone performance improved significantly!"
            </p>
          ...
          <div class="testimonial-card">
            ...
            <p class="testimonial-text">
              "Great selection of propellers and excellent customer service. Highly recommended!"
            </p>
            <div class="testimonial-author">
              <div class="author-avatar">
          ...
          <div class="testimonial-card">
            ...
            <p class="testimonial-text">
              "Reliable batteries and flight controllers. Perfect for professional drone operations."
            </p>
            <div class="testimonial-author">
              <div class="author-avatar">
...
/* Hero Section */
.hero-section {
  background: linear-gradient(rgba(10, 61, 98, 0.2), rgba(30, 74, 107, 0.5)), url('/images/hero.png');
