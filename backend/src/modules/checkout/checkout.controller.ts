...
export class CheckoutController {
  ...
  async processCheckout(@Body() checkoutDto: CheckoutDto, @Req() req: Request): Promise<OrderResponseDto> {
  ...
  async getOrder(@Param('orderNumber') orderNumber: string): Promise<OrderResponseDto> {
